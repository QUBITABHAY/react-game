...
function SingleWord() {
  ...
  const wordApi = `https://random-word-api.vercel.app/api?words=${number}`;
  ...
  return (
    <div
      className={`min-h-screen flex flex-col items-center justify-center transition-colors duration-300 ${isDarkMode
        ? "bg-gray-900"
    ...
    >
      ...
      <div
        className={`w-2xl max-w-4xl p-8 rounded-2xl transition-all duration-300 ${isDarkMode
          ? "bg-gray-800 text-white"
          : "bg-white/80 backdrop-blur-lg shadow-xl"}`}
      >
        <div className="text-center space-y-6 mb-8">
          <h1
            className={`text-4xl font-bold bg-gradient-to-r ${isDarkMode
          ...
          <div className="flex gap-4 justify-center items-center">
            <div className="flex-1">
              <input
                ...
                className={`w-sm px-4 py-3 rounded-lg transition-colors ${isDarkMode
                  ? "bg-gray-700 text-white border-gray-600"
                  : "bg-white text-gray-900 border-gray-200"} border focus:outline-none focus:ring-2 focus:ring-blue-500`}
            ...
            >
              <div className="flex flex-wrap gap-2">
                {words.map((word, index) => {
                  ...
                  let className = `px-3 py-1.5 rounded transition-colors ${isDarkMode
                    ? "bg-opacity-50"
                    : ""} `;
          ...
          {words.length > 0 &&
            <div className="space-y-4">
              <textarea
                ...
                className={`w-full p-4 rounded-lg resize-none transition-colors ${isDarkMode
                  ? "bg-gray-700 text-white placeholder-gray-400 border-gray-600"
                  : "bg-white text-gray-900 placeholder-gray-500 border-gray-200"} border focus:outline-none focus:ring-2 focus:ring-blue-500`}
                rows="3"
              ...
              {typingSpeed &&
                <div className="text-center space-y-4">
                  <div
                    className={`inline-block px-6 py-3 rounded-lg ${isDarkMode
                      ? "bg-green-900/50 text-green-200"
                      : "bg-green-100 text-green-700"}`}
                  >
                    <span className="font-medium">Speed:</span> {typingSpeed}{" "}
                    WPM
                  </div>
                  <div>
                    <button
